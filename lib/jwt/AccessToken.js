 ...
 * @param {string} options.endpointId - The endpoint ID
 */
function SpockGrant(options) {
  options = options || {};
  this.serviceSid = options.serviceSid;
  this.endpointId = options.endpointId;
}

_.extend(SpockGrant.prototype, {
  key: 'spock',
 ...
 * @param {string} options.endpointId - The endpoint ID
 */
function MrSpockGrant(options) {
  SpockGrant.call(this, options);
}

MrSpockGrant.prototype = _.create(ChatGrant.prototype, _.assign({
  '_super': SpockGrant.prototype,
  'constructor': SpockGrant
}));

MrSpockGrant.prototype.key = 'mrspock';
...
AccessToken.MrSpockGrant = MrSpockGrant;
AccessToken.SpockGrant = SpockGrant;
